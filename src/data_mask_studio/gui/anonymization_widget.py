...
class AnonymizationWidget(QWidget):
    """Interface da anonimização individual de arquivos CSV."""
    ...
    def __init__(
        ...
        self.profile_controls = ProfileControls(
            ...
            save_profile=self.save_as_profile,
            update_profile=self.update_selected_profile,
            rename_profile=self.rename_selected_profile,
            delete_profile=self.delete_selected_profile,
            selection_changed=self._update_profile_actions,
        )
        self.profile_combo = self.profile_controls.profile_combo
        self.apply_profile_button = self.profile_controls.apply_button
        self.save_profile_button = self.profile_controls.save_button
        ...
        self._profile_initialization_error = profile_initialization_error
    ...
    def refresh_profiles(self, selected_identifier: str | None = None) -> None:
        """Atualiza os perfis exibidos por este widget."""
        self._refresh_profiles(selected_identifier)
